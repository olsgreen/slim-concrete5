...
/** 
 * Add the Concrete5 HTTP basic authentication middleware
 * Comment the line below out if you don't want authentication via Concrete5 on all routes  */
$app->add(new \Concrete5\Middleware\Concrete5BasicAuth('Concrete5 API'));

/** Add the Concrete5 'bootstrap' runtime middleware  */
$app->add(new \Concrete5\Middleware\Concrete5());
...
$app->get('/', function () use ($app) {
    ...
    if(isset($app->concreteUser)) {
        $userName = $app->concreteUser->getUserName();
        $authString = " You have also logged on as $userName via the Concrete5 Basic HTTP auth plugin for Slim.";   
    }
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <p>
                <strong style="color:red;">You have access to the Concrete5 API for the site named $siteName.$authString</strong>
            </p>
            <section>
                <h2>Get Started</h2>
                <ol>
